...
import sate2012.avatar.android.googlemaps.MapViewer.Listener;
 ...
 */
public class MapViewerEE extends Fragment implements InfoWindowAdapter, 
OnCameraChangeListener, OnMapClickListener, OnMarkerClickListener, OnInfoWindowClickListener, OnMapLongClickListener {
	...
	public void onStart() {
		...
		final MapViewerEE fragment = this;
