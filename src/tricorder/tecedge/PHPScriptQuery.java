...
import sate2012.avatar.android.googlemaps.MarkerPlusTC;
...
public class PHPScriptQuery {
	...
	public ArrayList<MarkerPlusTC> getMapData(String condition) {

		ArrayList<MarkerPlusTC> list = new ArrayList<MarkerPlusTC>();
		MarkerPlusTC over;
		...
		for (int i = 0; i < typeArr.size(); i++) {
			...
			String info = date + "\n" + phone_ID + "\n" + data;
			over = new MarkerPlusTC(lat,longitude,info,type,date,phone_ID);
			list.add(over);
		}
		return list;
	}
