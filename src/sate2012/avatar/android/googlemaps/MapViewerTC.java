 ...
 *
 */
public class MapViewerTC extends Fragment implements InfoWindowAdapter, OnCameraChangeListener, 
OnMapClickListener, OnMarkerClickListener, OnInfoWindowClickListener, OnMapLongClickListener {
	...
	private MapViewerTC mapViewer;
	private ArrayList<MarkerPlusTC> markers;
	...
	public void onStart() {
		...
		markers = new ArrayList<MarkerPlusTC>();
	 ...
	 */
	public void addData(ArrayList<MarkerPlusTC> currentData){
		...
		for (int i = 0; i < currentData.size(); i++) {
			...
			MarkerPlusTC sensorItem = currentData.get(i);
	...
	public void generateData(){
		...
		for(int i = 0; i < size; i++){
			...
			markers.add(new MarkerPlusTC(lat, lon, info, type, date, phone_ID, imageID));
	...
	public class DownloadFilesTask extends AsyncTask<Context, Integer, Integer> {
		...
		private ArrayList<MarkerPlusTC> serverData;
